 ...
 *
 */
public class RenderFactoryGoldenEggThrown implements IRenderFactory
{
    ...
    {
        return new RenderGoldenEggThrown(renderManager, MagicBeans.itemGoldenEgg); // 0.5F is shadow size 
    }
