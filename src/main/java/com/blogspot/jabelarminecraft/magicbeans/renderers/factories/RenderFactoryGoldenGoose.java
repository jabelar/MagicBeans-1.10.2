 ...
 *
 */
public class RenderFactoryGoldenGoose implements IRenderFactory
{
    ...
    {
        return new RenderGoldenGoose(renderManager, new ModelGoldenGoose(), 0.5F); // 0.5F is shadow size 
    }
